...
if ( !function_exists( 'trueman_template_services_2_theme_setup' ) ) {
	add_action( 'trueman_action_before_init_theme', 'trueman_template_services_2_theme_setup', 1 );
	function trueman_template_services_2_theme_setup() {
		trueman_add_template(array(
			'layout' => 'services-2',
			'template' => 'services-2',
			'mode'   => 'services',
			'need_columns' => true,
			'title'  => esc_html__('Services /Style 2/', 'trueman'),
			'thumb_title'  => esc_html__('Medium square image (crop) S2', 'trueman'),
			'w'		 => 370,
			'h'		 => 222
		));
	}
...
// Template output
if ( !function_exists( 'trueman_template_services_2_output' ) ) {
	function trueman_template_services_2_output($post_options, $post_data) {
